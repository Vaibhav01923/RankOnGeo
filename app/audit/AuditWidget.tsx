  ...
  return (
    <div>
      ...
      <main className="max-w-5xl mx-auto px-5 sm:px-8 py-14 pb-36">
        ...
        {/* Empty state — the widget's own form, layered under the always-visible
            server-rendered marketing copy in page.tsx. Kept intentionally light
            (no H1/marketing prose here) since that content now lives server-side. */}
          ...
          return (
            <div>
              ...
              <div className="mb-10">
                ...
                <h2 className="font-signal-serif text-4xl leading-tight mb-3 text-[var(--ink)]" style={{ letterSpacing: "-0.02em" }}>
              ...
              {leaderboard.length > 0 && (
                <div className="bg-[var(--surface)] border border-[var(--line)] rounded-2xl p-7 mb-10">
                  <div className="flex items-center justify-between mb-5">
                    <div>
                      <h3 className="text-base font-bold text-[var(--ink)]">How you compare</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 items-start">
                ...
                <div className="bg-[var(--surface)] border border-[var(--line)] rounded-2xl p-7">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <h3 className="font-signal-serif text-2xl text-[var(--ink)] tracking-tight">{result.brand.name}</h3>
